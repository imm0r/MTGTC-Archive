...
-- Avatare liegen im öffentlichen Storage-Bucket "avatars" unter {uid}/avatar.
-- Öffentlich lesbar (für die public URL im Profil); geschrieben, geändert und
-- gelöscht werden darf nur der eigene Ordner (erster Pfadteil = eigene uid).
